...
"""CS 61A Presents The Game of Hog.""" #Divya: Solo Project
...
def picky_piggy(score):
    ...
    if score == 0:
        return 7
    if score % 6 != 0:
        revolving_location = score%6
    else:
        revolving_location = 6
    pow_to_10 = pow(10, (6-revolving_location)) 
    initial_n_digits = 142857//pow_to_10 
    points = initial_n_digits%10  
    return points
